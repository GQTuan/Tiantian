...
class WebController extends \yii\web\Controller
{
    ...
    {
        $allowActions = ['notify', 'index', 'ajax-update-status', 'wxtoken', 'wxcode', 'card', 'test', 'hx-weixin', 'wftnotify', 'zynotify', 'ajax-quick', 'outnotify', 'exchange-notify', 'admin-exchange-notify', 'bftnotify', 'new-bxnotify', 'klnotify', 'orange-notify', 'hope-notify', 'easypay-notify', 'dianyun-notify', 'mingwei-notify', 'yifu-notify'];
